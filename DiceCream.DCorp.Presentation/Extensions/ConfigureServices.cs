using DiceCream.DCorp.Presentation.Middlewares;
...
public static class ConfigureServicesExtensions
{
    public static IServiceCollection AddServices(this IServiceCollection services, IConfiguration configuration, IWebHostEnvironment environment)
    {
        try
        {
            ...
            services.AddMediatR(m => { m.RegisterServicesFromAssembly(typeof(GetPlayersQueryHandler).Assembly); });
                ...
                options.CustomizeProblemDetails = ctx =>
                {
                    ...
                    else if (ctx.Exception != null)
                    {
                        ...
                        ctx.ProblemDetails.Detail =
                            environment.IsDevelopment() ? ctx.Exception.ToString() : "Contact support.";
                    }
                };
            });
